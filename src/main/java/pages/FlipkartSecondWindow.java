...
//		//div[@id='container']//h1//span
		WebElement samsung2 = wd.findElement(By.xpath("//span[@class='_35KyD6']"));

		parenttext = samsung2.getText();
		System.out.println(parenttext);
		WebElement parentprice = wd.findElement(By.xpath("//div[@class='_1vC4OE _3qQ9m1']"));
	...
	public static void delivery_details_is_entered_and_item_added_to_cart() {
		wd.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement pincode = wd.findElement(By.xpath("//input[@class='_3X4tVa']"));
		pincode.sendKeys("600044");
		WebElement check = wd.findElement(By.xpath("//span[@class='_2aK_gu']"));
		check.click();
	...
	public static void mobile_details_should_be_validated_and_compared_with_previous_data() {
		wd.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement text = wd.findElement(By.xpath("//div//div//a[@class='_325-ji _3ROAwx']"));
		 childtext = text.getText();
		System.out.println(childtext);
		WebElement p2 = wd.findElement(By.xpath("//span[@class='pMSy0p XU9vZa']"));
